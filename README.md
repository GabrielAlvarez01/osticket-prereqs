...
<small> For step 2 of this process, download the file I left above on your VM. Once installed, extract the file on your desktop, and now let´s go to our control panel and follow this route: Uninstall a program > turn Windows features on/off> Internet Information Services > World Wide Web Services > Application development features and check CGI.

Let´s go to your VM C-drive and create a folder called "PHP", extract the file "php-7.3.8-nts-Win32-VC15-x86" from the installation file into PHP, and install php manager, rewrite_amd64, and VC redist </small>
